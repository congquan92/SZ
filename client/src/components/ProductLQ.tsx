              ...
              <Card className="group p-0 shadow-none rounded-none cursor-pointer gap-0 h-full">
                <CardContent className="relative p-2">
                  {calculateDiscountPercent(
                    ...
                    <Badge className="absolute top-2 left-2 bg-red-500 text-white text-xs px-1.5 py-0.5 rounded-none font-medium z-10">
                      {calculateDiscountPercent(
                        product.listPrice,
                        product.salePrice
                      )}
                ...
                <CardFooter className="flex flex-col gap-2 p-3 items-start">
                  <div className="flex flex-col gap-1 w-full">
                    <Link
                      to={`/product/${product.id}/${toSlug(
                        product.name
                      )}/${toSlug(product.description)}`}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className="bg-yellow-100 text-yellow-800 text-xs px-1.5 py-0.5 rounded-none font-medium">
