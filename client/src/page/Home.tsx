    ...
    <div className="container mx-auto px-2 space-y-4 ">
      ...
      <div className="mt-3">
        <div className="w-full max-w-[1600px] mx-auto mb-3">
          <img
            src="https://cdn.hstatic.net/files/1000253775/file/banner-hang-moi-pc.jpg"
            alt="Banner Effect"
      ...
      <div className="mt-3">
        <div className="w-full max-w-[1600px] mx-auto mb-3">
          <img
            src="https://file.hstatic.net/1000253775/file/h_ng_b_n_ch_y_6__2_.jpg"
            alt="Banner Effect"
            className="w-full h-auto"
          />
        </div>
        <Title
          ...
          subtitle="Khám Phá Sản Phẩm Bán Chạy"
        />
        {/* dung carousel */}
        <ProductCarousel />
      </div>
      ...
      <div className="mt-3">
        <div className="w-full max-w-[1600px] mx-auto mb-3">
          <img
            src="https://file.hstatic.net/1000253775/file/flashsale_dk_b277e7264a9c43a190f1bbbd14166c67.jpg"
            alt="Banner Effect"
            className="w-full h-auto"
          />
        </div>
